...
class CreateCustomersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->string('sanction_date',100)->nullable();
            ...
            $table->string('dac_issuance_date',100)->nullable();
            $table->string('disbursement_date',100)->nullable();
            $table->string('amount_disbursed',100)->nullable();
            $table->string('expiry_date_as_per_dac',100)->nullable();
            ...
            $table->string('personal_guaranteeGuarantor_no_1_detail_name',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_cnic',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_contact',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_dept_business',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_dept_business_address',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_bps',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_pp_if_salaried',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_1_detail_address',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_name',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_cnic',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_contact',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_dept_business',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_dept_business_address',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_bps',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_pp_if_salaried',100)->nullable();
            $table->string('personal_guaranteeGuarantor_no_2_detail_address',100)->nullable();
            ...
            $table->string('valuation_date_of_valuation',100)->nullable();
            $table->string('insurance_company',100)->nullable();
            $table->string('insurance_date_of_insurance',100)->nullable();
            $table->string('insurance_insurance_amount',100)->nullable();
            $table->string('insurance_date_of_expiry_of_insurance',100)->nullable();
            $table->string('insurance_claim_outstanding_claim_amount',100)->nullable();
            $table->string('insurance_claim_outstanding_date_of_claim',100)->nullable();
            ...
            $table->string('litigation_status_date_of_final_settlement',100)->nullable();
            $table->timestamps();
        });
    }
