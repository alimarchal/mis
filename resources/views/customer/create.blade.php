            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-2">
                        ...
                        <input type="text" class="form-control" name="customer[borrower_name]">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" title="" name="customer[s_o_d_o_w_o]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom04" title="" name="customer[designation]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom08" title="" name="customer[pp]">
                        <div class="invalid-feedback">
                            Please provide a Designation.
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input class="custom-select" title="" id="validationCustom15"
                               name="customer[renewal_enhancement_fresh_sanction]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom16" title=""
                               name="customer[amount_sanctioned]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" class="form-control" id="validationCustom21" title=""
                               name="customer[dac_issuance_date]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="date" class="form-control" id="validationCustom22" title=""
                               name="customer[disbursement_date]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" id="validationCustom23" title=""
                               name="customer[amount_disbursed]">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom26" title=""
                               name="customer[branch_manager_name_while_sanctioning]">
                        <div class="invalid-feedback">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="customer[installment_total_installment]customer[]">
                        <div class="invalid-feedback">
                            Please provide a Branch Manager Name.
                        </div>
                    </div>
